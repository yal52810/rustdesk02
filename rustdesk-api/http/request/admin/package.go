...
// PackageForm is the package create/update payload.
type PackageForm struct {
	...
	FileTransferLimitMB int     `json:"file_transfer_limit_mb" validate:"required,gte=1"`
...
// ServerForm is the server create/update payload.
